"""
功能：从wiff分组parquet提取hard decoy+target+regular decoy，target:decoy=1:1
输入：
    --db_dir /home/yiwen/AIPC/database/wiff
    --config /home/yiwen/AIPC/scripts/organized_attantion/config/model.yaml
    --output_dir /home/yiwen/AIPC/scripts/organized_attantion/data/dataset/hard_decoy/wiff
输出：
    data/dataset/hard_decoy/wiff/*.pkl.gz（6文件，~115万target+115万decoy 1:1）
    日志 > /tmp/hard_decoy_wiff.log
"""
...
def parse_args():
    ...
    p.add_argument("--db_dir", type=str, default="/home/yiwen/AIPC/database/wiff")
    p.add_argument("--config", type=str, default="/home/yiwen/AIPC/scripts/organized_attantion/config/model.yaml")
    p.add_argument("--output_dir", type=str, default="/home/yiwen/AIPC/scripts/organized_attantion/data/dataset/hard_decoy/wiff")
